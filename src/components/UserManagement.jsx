...
export default function UserManagement() {
  ...
  const userActions = [
    { action: 'Get User by Username', params: 'username' },
    { action: 'Get All Users', params: 'No parameters required' },
    { action: 'Add User', params: 'role, username, password, firstName, lastName' },
    { action: 'Delete User', params: 'username' },
  ];
            ...
            {selectedAction.params.split(', ').map(param => (
              param.toLowerCase() === 'no parameters required' ? (
                ...
                <div key={param} className="form-field">
                  <label>{param}:</label>
                  <input
                    type={param.toLowerCase() === 'password' ? 'password' : 'text'}
                    name={param}
